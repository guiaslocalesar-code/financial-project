...
class Transaction(Base):
    ...
    budget = relationship("ExpenseBudget", foreign_keys=[budget_id], back_populates="transaction")
    income_budget = relationship("IncomeBudget", foreign_keys=[income_budget_id], back_populates="transaction")

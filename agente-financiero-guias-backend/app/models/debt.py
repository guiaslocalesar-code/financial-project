...
class Debt(Base):
    ...
    interest_type: Mapped[InterestType] = mapped_column(SQLEnum(InterestType, name="interesttype"), nullable=True)
    ...
    status: Mapped[DebtStatus] = mapped_column(SQLEnum(DebtStatus, name="debtstatus"), default=DebtStatus.PENDING)

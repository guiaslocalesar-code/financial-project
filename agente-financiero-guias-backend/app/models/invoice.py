...
class Invoice(Base):
    ...
    invoice_type: Mapped[InvoiceType] = mapped_column(SQLEnum(InvoiceType, name="invoicetype"), nullable=False)
    ...
    status: Mapped[InvoiceStatus] = mapped_column(SQLEnum(InvoiceStatus, name="invoicestatus"), default=InvoiceStatus.DRAFT)
